use anyhow::anyhow;
use highway::{HighwayHash, HighwayHasher as Hasher};
use log;
...
impl ResourceId {
    ...
    pub fn compute_reader<R: Read>(
        ...
        let hash: u64 = hasher.finalize64();
...
mod tests {
    ...
    fn compute_id_test() {
        ...
        assert_eq!(id1.hash, 3309468183667921738);
        ...
        assert_eq!(id2.hash, 3309468183667921738);
